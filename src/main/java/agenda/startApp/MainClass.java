...
public class MainClass
{
	...
	public static void afisActivitate(RepositoryActivity activityRep,
		...
		try {
			...
			System.out.println("Activitatile userului "+user.getName()+"("+user.getUsername()+") din ziua " + d.toString() + ": ");
	...
	public static void adaugActivitate(RepositoryActivity activityRep,
		...
		try {
			...
			System.out.println("Cine se alatura? (name,contact), introdu nimic pentru a incheia");
			String contUsername;
			do
			{
